          ...
          <div class="grid items-start grid-cols-1 gap-12 md:grid-cols-2">
            <div>
              <div class="max-w-xl lg:p-10">
                <div>
                  <p class="text-2xl font-medium tracking-tight text-black sm:text-4xl">Zibah Creations</p>
                  <p class="max-w-xl mt-4 text-base tracking-tight text-gray-600">
                    Use this paragraph to share information about your company or products. Make it engaging and interesting, and showcase your
              ...
              <div class="flex flex-col gap-3 mt-10 lg:flex-row lg:gap-6">
                ...
                >
                  ...
                  >
                    <path d="M12.75 15l3-3m0 0l-3-3m3 3h-7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" stroke-linecap="round" stroke-linejoin="round"></path>
                  </svg>
                </a>
              </div>
            </div>
