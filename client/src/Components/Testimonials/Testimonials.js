        ...
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
          <div class="mt-4 flex items-center gap-4">
            ...
            <div>
              ...
              <p class="mt-0.5 text-xs text-gray-500">Based on 23 reviews</p>
            </div>
          </div>
          ...
          <div class="mt-8 grid grid-cols-1 gap-x-16 gap-y-12 lg:grid-cols-2">
            <blockquote>
              ...
              <p class="mt-2 text-gray-700">
                ...
                will be doing injustice to try to describe these accessories, one needs to own them and have your experience. The person behind this
                brand, I give all the respect and it's like she gives a different feel that compliments the owner. Zibah for me all out 🥰🥰🔥🔥♥
              </p>
            ...
            <blockquote>
              ...
              <p class="mt-2 text-gray-700">
                ...
                and suits my personality to the dot. It is worth every dollar, she charges (which in my honest opinion, is not much) considering the
                designs
              </p>
